...
public class TranslationService {
    ...
    public Flux<Translation> getAllTranslations() {
        return translationRepository.findByDeletedFalseOrderByCreatedAtDesc();
    }
    ...
    public Mono<Translation> updateTranslation(String id, Translation updatedTranslation) {
    ...
    public Mono<Translation> logicalDeleteTranslation(String id) {
        return translationRepository.findById(id)
                .flatMap(translation -> {
    ...
    public Mono<Translation> restoreTranslation(String id) {
        return translationRepository.findById(id)
                .flatMap(translation -> {
